...
@Injectable()
export class ResendOutboundEmailService implements OutboundEmailService {
  private readonly logger = new Logger(ResendOutboundEmailService.name);
