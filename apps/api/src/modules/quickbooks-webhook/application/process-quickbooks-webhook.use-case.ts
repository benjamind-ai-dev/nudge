...
export interface ProcessQuickbooksWebhookInput {
  rawBody: Buffer;
}

@Injectable()
export class ProcessQuickbooksWebhookUseCase {
  private readonly logger = new Logger(ProcessQuickbooksWebhookUseCase.name);
